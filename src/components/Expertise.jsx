      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            Building Bulletproof Infrastructure with DevOps & Cloud
          </h2>
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            Combining Linux mastery, container orchestration, and automation to create resilient systems that never sleep.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          <TagCard
            ...
            text="Provisioning and managing AWS (EC2, EKS, S3, VPC, IAM, RDS, Lambda) with Terraform for multi-environment IaC — cost-controlled, compliance-tagged, and audit-ready."
          ...
          <TagCard
            number="02"
            title="CI/CD & GitOps"
            text="Building immutable Docker pipelines across GitHub Actions, GitLab CI/CD, Bitbucket, and ArgoCD for 15+ microservices — zero rollback incidents over 12 months of Blue/Green and Canary deployments."
          ...
          <TagCard
            ...
            text="Operating production Kubernetes clusters — on-prem air-gapped and EKS — with HPA, RBAC, PDB, Helm, and network policies. 99.9%+ SLA across 5+ enterprise deployments."
          ...
          <TagCard
            ...
            text="Prometheus/Grafana SLI/SLO alerting, ELK + Graylog audit pipelines, VAPT remediation — zero critical findings across three banking audits with 12 CVEs resolved."
          ...
          <motion.div
            ...
            className="hidden md:block absolute top-[1250px] left-[60%] font-serif italic text-3xl text-gray-600 rotate-6"
          >
            Keeping it running, always.
          </motion.div>
        </div>
      </div>
    </section>
